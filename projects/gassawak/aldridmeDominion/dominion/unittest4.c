...
int main() {
	...
	if (gameOver == 0){
		printf("isGameOver(): PASS for >0 province cards and all kingdom cards are >0. Game continues. \n");
	}
	else{
	...
	gameOver = isGameOver(&G);
	if (gameOver == 1){
		printf("isGameOver(): PASS when supplyCount for province is 0 and all kingdom cards are >0. Game is over. \n");
	}
	else{
	...
	gameOver = isGameOver(&G);
	if (gameOver == 1){
		printf("isGameOver(): PASS when supplyCount for province >0, and for mine, sea_hag, and treasure_map is 0. Game is over. \n");
	}
	else{
	...
	gameOver = isGameOver(&G);
	if (gameOver == 1){
		printf("isGameOver(): PASS when supplyCount for province >0, and for adventurer, feast, and gardens is 0. Game is over. \n");
	}
	else{
